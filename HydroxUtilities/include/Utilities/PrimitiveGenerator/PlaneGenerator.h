...
namespace he
{
  namespace util
  {
    ...
    public:
      ...
      static void generatePlane(std::vector<Vector<float, 3>>& position, std::vector<Vector<float, 3>>& normal, unsigned int levelOfDetail);
      static void generatePlane(std::vector<Vector<float, 3>>& position, std::vector<unsigned int>& index, unsigned int levelOfDetail);
      static void generatePlane(std::vector<Vector<float, 3>>& position, std::vector<unsigned int>& index, std::vector<Vector<float, 3>>& normal, unsigned int levelOfDetail);
    ...
    private:
      ...
      static void generateIndexedNormals(const std::vector<Vector<float, 3>>& position, std::vector<unsigned int>& index, std::vector<Vector<float, 3>>& normal);
