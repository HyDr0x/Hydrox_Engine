...
namespace he
{
  namespace renderer
  {
    InsertGeometryTraverserIndirectLightingPass::InsertGeometryTraverserIndirectLightingPass(const xBar::IGeometryContainer& geometryContainer, util::SingletonManager *singletonManager) :
    ...
    util::SharedPointer<IRenderGroup> InsertGeometryTraverserIndirectLightingPass::getCreatedRenderNode() const
    {
