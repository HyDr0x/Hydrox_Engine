...
namespace he
{
  namespace renderer
  {
    ...
    void RemoveGeometryTraverserRenderPass::removeGeometry(TreeNode *treeNode, util::SharedPointer<const xBar::IGeometryContainer> geometryContainer, util::SingletonManager *singletonManager)
    {
