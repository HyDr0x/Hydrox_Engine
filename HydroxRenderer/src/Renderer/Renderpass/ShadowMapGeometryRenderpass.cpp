...
namespace he
{
  namespace renderer
  {
    ShadowMapGeometryRenderpass::ShadowMapGeometryRenderpass() : m_lightIndex(0)
    {
    }

    ShadowMapGeometryRenderpass::~ShadowMapGeometryRenderpass()
    {
    }

    void ShadowMapGeometryRenderpass::setLightIndex(int lightIndex)
    {
      m_lightIndex = lightIndex;
    }

    void ShadowMapGeometryRenderpass::drawRenderpass() const
    {
