...
namespace he
{
  namespace renderer
  {
    DebugGeometryRenderpass::DebugGeometryRenderpass()
    {
    }
    ...
    void DebugGeometryRenderpass::initialize(util::SingletonManager *singletonManager, sh::ShaderContainer::Renderpass renderPass, std::vector<util::SharedPointer<SamplerObject>> samplerObjects)
    {
    ...
    void DebugGeometryRenderpass::drawRenderpass() const
    {
