...
namespace he
{
    ...
    void Billboard::setAnimation(util::Vector<unsigned int, 2> number)
    {
      assert(number[1] < m_animNumber[1] && number[0] < m_animNumber[0]);
      m_animCount = number;
    }

    util::Vector<unsigned int, 2> Billboard::getAnimationNumber()
    {
      return m_animNumber;
    }

    util::Vector<unsigned int, 2> Billboard::getAnimationCount()
    {
      return m_animCount;
    }
    ...
    void Billboard::setTranslation(util::Vector<float, 3> v)
    {
	    m_translate = v;
    }
    ...
    void Billboard::addTranslation(util::Vector<float, 3> v)
    {
	    m_translate = v;
    }
    ...
    void Billboard::setScale(util::Vector<float, 2> s)
    {
	    m_scale = s;
    }
    ...
    void Billboard::addScale(util::Vector<float, 2> s)
    {
	    m_scale = s;
    }
    ...
    util::Vector<float, 3> Billboard::getPosition()
    {
	    return m_translate;
    }

    util::Vector<float, 2> Billboard::getScale()
    {
	    return m_scale;
    }

    util::Matrix<float, 3> Billboard::getTexTransformationMatrix()
    {
    ...
    util::ResourceHandle Billboard::getTextureID() const
    {
	    return m_texID;
    }
	}
