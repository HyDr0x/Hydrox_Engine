#ifndef RENDERGEOMETRYTRAVERSERDEBUG_H_
#define RENDERGEOMETRYTRAVERSERDEBUG_H_
...
namespace he
{
  ...
  namespace renderer
  {
    class RenderGeometryTraverserDebug : public Traverser
    {
    public:

      RenderGeometryTraverserDebug();
      virtual ~RenderGeometryTraverserDebug();
