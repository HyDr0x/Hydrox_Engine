#ifndef INSERTREFLECTIVESHADOWGEOMETRYTRAVERSER_H_
#define INSERTREFLECTIVESHADOWGEOMETRYTRAVERSER_H_
...
namespace he
{
  ...
  namespace renderer
  {
    ...
    class InsertReflectiveShadowGeometryTraverser : public Traverser
    {
    public:

      InsertReflectiveShadowGeometryTraverser(util::SharedPointer<IRenderGroup> renderGroup,
        const xBar::IGeometryContainer& geometryContainer,
        util::SingletonManager *singletonManager, 
        RenderShaderContainer *container);

      virtual ~InsertReflectiveShadowGeometryTraverser();
