  ...
  namespace sh
  {
    ...
    public:
      ...
      enum Renderpass
      {
        ...
        PULLSHADER = 23,
        SPECULARCACHEINDEXMAPCREATION = 24,
        SPECULARLIGHTMAPCREATION = 25,
        DEBUGINTEGERTEXTURE = 26,
        SPECULARJUMPFLOODALGORITHM = 27,
        SPECULARJUMPFLOODISLANDREMOVALALGORITHM = 28,
        SHOWSPECULARCACHEDELAUNAYTRIANGULATION = 29,
        SPECULARCACHEPROXYLIGHTMAPDELAUNAYTRIANGULATION = 30,
        SPECULARCACHEREFINEDELAUNAYTRIANGULATION = 31,
        INDIRECTSPECULARERRORSPOTLIGHTING = 32,
        SHOWLINES = 33,
        PROXYLIGHTWEIGHTCREATION = 34,
        INDIRECTLIGHTSCREENVERTEXEXTRACTION = 35,
        PASSNUMBER
      };
      ...
      enum Computepass
      {
        ...
        VISIBILITYMAPCREATION,
        SPECULARTUBECREATION,
        SPECULARCACHEPOSITIONFILTERX,
        SPECULARCACHEPOSITIONFILTERY,
        SPECULARCACHEPOSITIONCREATIONX,
        SPECULARCACHEPOSITIONCREATIONY,
        SPECULARCACHEOFFSETUPSWEEP,
        SPECULARCACHEOFFSETDOWNSWEEP,
        SPECULARCACHECREATION,
        SPECULARPROXYLIGHTCREATION,
        BVHCACHEINSERTION,
        BVHBOUNDINGBOX,
        BVHNODEPOSITIONCALCULATION,
        BVHCACHEINDEXCALCULATION,
        SPECULARCACHEPOSITIONCREATIONXREDUCE,
        SPECULARCACHEPOSITIONCREATIONYREDUCE,
        SPECULARCACHEBOUNDINGBOXCOMPUTATION,
        SPECULARCACHEINDEXLISTCREATION,
        SPECULARCACHETRIANGLEINDEXOFFSETCALCULATION,
        SPECULARCACHEFILLTRIANGLEINDICES,
        SPECULARCACHEEDGEFILTER,
        SPECULARCACHEVERTEXBUFFERCREATION,
        SPECULARCACHEEDGECACHECREATION,
        SPECULARCACHEVORONOIDIAGRAMCORNERREPAIR,
        LINEARDEPTHBUFFERCREATION,
        SPECULARCACHEEDGEVERTEXCREATION,
        SPECULARDEBUGCACHEVERTEXINDEXBUFFERCREATION,
        SPECULARPROXYLIGHTBUFFERCREATIONDIVIDE,
        SPECULARCACHEEDGEVERTEXEXTRACTION,
        INDIRECTLIGHTMAPCREATION,
        REFLECTIVESHADOWMAPDOWNSAMPLING,
        GBUFFERDOWNSAMPLING,
        INDIRECTLIGHTUPSAMPLING,
        COMPUTESHADERNUMBER
      };
