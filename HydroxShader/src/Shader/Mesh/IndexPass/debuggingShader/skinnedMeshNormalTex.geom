...
void main()
{
	...
	if(triangleCacheBorderIndices.x < INT32_MAX)
	{
		...
		for(uint i = triangleCacheBorderIndices.x; i < triangleCacheBorderIndices.y; i++)
		{
			...
			gsout_tangentToWorld = vsout_tangentToWorld[0];
			...
			gsout_tangentToWorld = vsout_tangentToWorld[1];
	...
	gsout_tangentToWorld = vsout_tangentToWorld[2];
