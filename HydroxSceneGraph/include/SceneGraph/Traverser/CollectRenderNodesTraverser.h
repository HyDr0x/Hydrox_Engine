#ifndef COLLECTRENDERNODESTRAVERSER_H_
#define COLLECTRENDERNODESTRAVERSER_H_
...
namespace he
{
	namespace sg
	{
    class CollectRenderNodesTraverser : public Traverser
    {
    public:

      CollectRenderNodesTraverser(util::EventManager& eventManager, std::vector<float> lodRanges, util::Vector<float, 3> camPos);
      virtual ~CollectRenderNodesTraverser();
