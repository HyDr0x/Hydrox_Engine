...
namespace he
{
    ...
    public:
      ...
      AnimatedGeoNode(const std::vector<util::Matrix<float, 4>>& inverseBindPoseMatrices, util::EventManager *eventManager, util::ResourceHandle meshHandle, util::ResourceHandle materialHandle, bool transparency, bool instanced, const std::string& nodeName, GroupNode* parent = nullptr, TreeNode* nextSibling = nullptr);
